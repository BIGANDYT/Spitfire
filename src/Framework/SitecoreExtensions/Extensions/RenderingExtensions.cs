namespace Habitat.Framework.SitecoreExtensions.Extensions
{
    ...
    public static class RenderingExtensions
  {
    ...
    {
      return MainUtil.GetBool(rendering.Parameters[Habitat.Framework.SitecoreExtensions.Constants.DynamicPlaceholdersLayoutParameters.UseStaticPlaceholderNames], false);
    }
